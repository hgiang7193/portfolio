...
Assert-Contains $page 'mailto:gianghuongtran1102@gmail.com' 'Portfolio email link is missing.'
...
Assert-Contains $cv 'gianghuongtran1102@gmail.com' 'CV email is missing.'
